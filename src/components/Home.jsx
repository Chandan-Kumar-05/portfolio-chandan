...
const Home = () => {
  ...
  Cybersecurity Specialist & Network Engineer | Skilled in Software Technologies, Ethical Hacking,
</p>
<p className='mt-3 text-xl' style={{ marginLeft: '5px' }}>
  and Building Scalable, High-Performance Backend Systems. -{'>'} ...🚀
</p>
