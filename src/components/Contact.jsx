...
const Contact = () => {
		...
		emailjs
			.send(
				...
				EMAIL_JS_TEMPLATE_ID,
				{
					...
					reply_to: user_email,
					to_email: "chandan5062002@gmail.com",
	...
	return (
        ...
        <div className='relative z-0 bg-black w-screen h-screen mt-12'>   
			<div className='text-white contact overflow-x-hidden pt-20 mt-12 ' id='contact'>
				<div className='z-10 w-full sm:w-[650px] m-auto p-12 rounded-2xl' >
